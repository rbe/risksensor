...
public class BrakeObserverImpl extends AbstractObserver implements BrakeObserver {

    private static final Logger logger;

    static {
        logger = Logger.getLogger(BrakeObserverImpl.class.getName());
    }

    public BrakeObserverImpl(TourState tourState) {
        super(tourState);
    }

    public void processBrakeEvent(TRsTourData tourData) {
        ...
        tourState.getPointsAccount().addBrakePointsSecond(tourData.getPoints());
    }
